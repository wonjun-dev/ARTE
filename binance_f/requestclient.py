...
class RequestClient(object):
    ...
    def get_all_mark_price(self) -> any:
        """
        Mark Price (MARKET_DATA)
        ...
        Mark Price and Funding Rate
        """
        response = call_sync(self.request_impl.get_all_mark_price())
        self.refresh_limits(response[1])
        return response[0]

    def get_funding_rate(
        self, symbol: "str", startTime: "long" = None, endTime: "str" = None, limit: "int" = None
    ) -> any:
        """
    ...
    def get_liquidation_orders(
        self, symbol: "str" = None, startTime: "long" = None, endTime: "str" = None, limit: "int" = None
    ) -> any:
        """
    ...
    def cancel_list_orders(
        self, symbol: "str", orderIdList: "list" = None, origClientOrderIdList: "list" = None
    ) -> any:
        """
    ...
    def get_position_margin_change_history(
        self, symbol: "str", type: "int" = None, startTime: "int" = None, endTime: "int" = None, limit: "int" = None
    ) -> any:
        """
    ...
    def get_open_interest_stats(
        self, symbol: "str", period: "str", startTime: "str" = None, endTime: "str" = None, limit: "int" = 30
    ) -> any:
        """
    ...
    def get_top_long_short_accounts(
        self, symbol: "str", period: "str", startTime: "str" = None, endTime: "str" = None, limit: "int" = 30
    ) -> any:
        """
    ...
    def get_top_long_short_positions(
        self, symbol: "str", period: "str", startTime: "str" = None, endTime: "str" = None, limit: "int" = 30
    ) -> any:
        """
    ...
    def get_global_long_short_accounts(
        self, symbol: "str", period: "str", startTime: "str" = None, endTime: "str" = None, limit: "int" = 30
    ) -> any:
        """
    ...
    def get_blvt_nav_candlestick_data(
        self,
        symbol: "str",
        interval: "CandlestickInterval",
        startTime: "long" = None,
    ...
    def get_position_v2(self, symbol=None) -> any:
        """
        Position Information (USER_DATA)

        GET /fapi/v2/positionRisk (HMAC SHA256) Get current account information.
        """
        response = call_sync(self.request_impl.get_position_v2(symbol=symbol))
        self.refresh_limits(response[1])
        return response[0]

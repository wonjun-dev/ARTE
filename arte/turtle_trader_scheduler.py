...
from arte.indicator.atr import ATR
from arte.strategy.turtle_trading import TurtleTrading
...
class TurtleTrader:
    ...
    def __init__(self, client, symbol):
        ...
        self.strategy = TurtleTrading(indicator_manager=self.im)
        self.strategy_manager = StrategyManager(
            self.oh, self.strategy, self.bot_manager, max_order_count=5, verbose_bot=False
        )

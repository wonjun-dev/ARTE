...
class SignalState:
    ...
    def __init__(self, symbol, tm_upbit, tm_binance):
        ...
        self.spread = deque(maxlen=24000)
        self.kalman_initialize()

    def kalman_initialize(self):
        self.kf_upbit = KalmanFilter(transition_matrices = [1],
        ...
        self.upbit_state_means, self.upbit_state_covs = self.kf_upbit.filter()


        self.kf_binance = KalmanFilter(transition_matrices = [1],
                      observation_matrices = [1],
                      initial_state_mean = 0,
                      initial_state_covariance = 1,
                      observation_covariance=1,
        ...
        self.binance_state_means = np.zeros((1, 1))
        self.binance_state_covs = np.zeros([1,1,1])
